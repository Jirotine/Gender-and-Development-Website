...
<div class="box" id="box">
    <div class="row">
        <div class="col-sm-12 col-lg-6 col-md-6">
            <div class="box">
                <form id="surveyForm" action="../Util/surveyHandler2.php" method="post" onsubmit="return validateForm()">
                    <div class="Question">
                        <p>1. Are you aware of the specific behaviors that are prohibited under the Safe Space Act?</p>
                    ...
                    <div class="Question">
                        <p>2. Do you believe that the Safe Space Act is effective in creating safer environments in public and private spaces?</p>
                    ...
                    <div class="Question">
                        <p>3. Do you believe that the Safe Space Act has improved the handling of harassment and violence cases?</p>
            ...
            <div class="col-sm-12 col-lg-6 col-md-6">
                <div class="box1">
                    <div class="Question">
                        <p>4. Do you think the Safe Space Act should include stricter penalties for offenders?</p>
                    ...
                    <div class="Question">
                        <p>5. Do you think that more resources should be allocated to support victims of harassment and violence?</p>
